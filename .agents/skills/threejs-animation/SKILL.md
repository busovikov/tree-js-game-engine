...
- **Status:** minimal in v1 — `Engine` loop in `packages/engine/src/engine.ts` (`tick(dt)`)
- **ScriptRef / clips:** stub — see `IMPLEMENTATION_PLAN.md` Phase 5
- **Docs:** `docs/techstack.md` — animation out of scope unless user requests
