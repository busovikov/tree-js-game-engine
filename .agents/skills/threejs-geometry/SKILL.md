...
- **Primitives:** `packages/engine/src/mesh-factory.ts` — `createGeometry`, schema `MeshRenderer.geometryType`
- **Instancing:** stub only — extend `RenderSyncSystem`, see `RENDER_PLAN.md` § render buckets
- **Docs:** `docs/architecture.md`, `docs/links.md`
