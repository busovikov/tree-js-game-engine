...
import { MeshRendererComponent, type MeshRenderer } from '@haku/engine'
import type { AssetRef } from '@haku/schema'
import type { ColliderBakeSource } from '@haku/physics'
import { meshRendererKey, normalizeMeshRenderer } from '@haku/engine'
