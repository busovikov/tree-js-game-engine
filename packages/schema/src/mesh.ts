  ...
  BoxGeometry: [
    {
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Box size along the X axis.',
    },
    {
      key: 'height',
      label: 'Height',
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Box size along the Y axis.',
    },
    {
      key: 'depth',
      label: 'Depth',
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Box size along the Z axis.',
    },
  ],
  SphereGeometry: [
    { key: 'radius', label: 'Radius', default: 0.5, min: 0.01, step: 0.1, hint: 'Sphere radius.' },
    {
      ...
      max: 64,
      step: 1,
      hint: 'Horizontal mesh subdivisions — more segments = smoother sphere.',
    },
    {
      key: 'heightSegments',
      ...
      max: 64,
      step: 1,
      hint: 'Vertical mesh subdivisions — more segments = smoother sphere.',
    },
  ],
  PlaneGeometry: [
    {
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Plane size along the X axis.',
    },
    {
      key: 'height',
      label: 'Height',
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Plane size along the Y axis.',
    },
  ],
  CylinderGeometry: [
    {
      ...
      min: 0,
      step: 0.1,
      hint: 'Radius of the top cap (0 = cone tip).',
    },
    {
      key: 'radiusBottom',
      label: 'Radius Bottom',
    ...
    },
    {
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Cylinder height along the Y axis.',
    },
    {
      key: 'radialSegments',
      ...
      max: 64,
      step: 1,
      hint: 'Subdivisions around the circumference — more = rounder.',
    },
  ],
  ConeGeometry: [
    {
    ...
    },
    {
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Cone height along the Y axis.',
    },
    {
      key: 'radialSegments',
      label: 'Radial Segments',
  ...
  TorusGeometry: [
    {
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Distance from torus center to the tube center.',
    },
    {
      key: 'tube',
      label: 'Tube',
      ...
      min: 0.01,
      step: 0.05,
      hint: 'Radius of the tube cross-section.',
    },
    {
      key: 'radialSegments',
      label: 'Radial Segments',
      ...
      max: 64,
      step: 1,
      hint: 'Subdivisions of the tube cross-section.',
    },
    {
      key: 'tubularSegments',
      ...
      max: 128,
      step: 1,
      hint: 'Subdivisions along the ring — more = smoother torus.',
    },
  ],
  RingGeometry: [
    {
      ...
      min: 0,
      step: 0.05,
      hint: 'Radius of the ring hole (0 = solid disc).',
    },
    {
      key: 'outerRadius',
      label: 'Outer Radius',
    ...
    },
    {
      ...
      max: 64,
      step: 1,
      hint: 'Subdivisions around the ring — more = rounder.',
    },
  ],
  CapsuleGeometry: [
    {
      ...
      min: 0.01,
      step: 0.05,
      hint: 'Radius of the capsule caps and body.',
    },
    {
      key: 'length',
      label: 'Length',
      ...
      min: 0.01,
      step: 0.1,
      hint: 'Length of the cylindrical middle section.',
    },
    {
      key: 'capSegments',
      label: 'Cap Segments',
      ...
      max: 32,
      step: 1,
      hint: 'Subdivisions of the hemispherical caps.',
    },
    {
      key: 'radialSegments',
      label: 'Radial Segments',
